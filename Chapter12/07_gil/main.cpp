...
int main(int argc, char* argv[])
{
    ...
    typedef boost::mpl::vector3<boost::gil::gray8_image_t, boost::gil::gray16_image_t, boost::gil::rgb8_image_t>
        img_types;
    boost::gil::any_image<img_types> source;
#else
    // Boost.GIL now uses variadic templates
    boost::gil::any_image<boost::gil::gray8_image_t, boost::gil::gray16_image_t, boost::gil::rgb8_image_t> source;
#endif
