...
typedef coalesce<boost::mpl::true_, boost::mpl::int_<5>, boost::mpl::not_<_1>, boost::mpl::next<_1>>::type res1_t;
BOOST_STATIC_ASSERT((res1_t::value == 6));

typedef coalesce<boost::mpl::false_, boost::mpl::int_<5>, boost::mpl::not_<_1>, boost::mpl::next<_1>>::type res2_t;
BOOST_STATIC_ASSERT((res2_t::value));

typedef coalesce<
    boost::mpl::false_, boost::mpl::false_, boost::mpl::not_<_1>, boost::mpl::not_<boost::mpl::not_<_1>>>::type res3_t;
BOOST_STATIC_ASSERT((res3_t::value));

typedef coalesce<
    boost::mpl::false_, boost::mpl::true_, boost::mpl::not_<_1>, boost::mpl::not_<boost::mpl::not_<_1>>>::type res4_t;
