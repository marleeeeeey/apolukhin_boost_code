...
int main()
{
    ...
    // TODO tyulenev: error: implicit instantiation of undefined template 'boost::array<cat, 10>'
...
{
    std::string result;
    stringize_cpp11_impl(t, stringize_functor(result), std::make_index_sequence<std::tuple_size<Tuple>::value>());
    return result;
}
