...
struct apply_if
{
    ...
    typedef typename boost::mpl::if_c<condition_t::value, applied_type, boost::mpl::identity<Fallback>>::type type;
};
...
typedef apply_if<boost::make_unsigned<_1>, int, boost::is_integral<_1>>::type res1_t;
...
typedef apply_if<boost::make_unsigned<_1>, float, boost::is_integral<_1>>::type res2_t;
